...
export const heroPromise = "Stop losing good jobs from missed calls, slow replies, and forgotten follow-up.";
...
export const tradePages = {
  electricians: {
    path: "/electricians",
    eyebrow: "Electrical front desk system",
    title: "Stop Losing Electrical Jobs From Missed Calls And Slow Follow-Up",
  ...
  plumbersDrainage: {
    ...
    eyebrow: "Plumbing and drainage front desk",
    title: "Catch Urgent Plumbing Calls, Book More Site Visits, And Follow Up Quotes",
  ...
  roofers: {
    path: "/roofers",
    eyebrow: "Roofing front desk system",
    title: "Capture More Roof Inspection Requests, Reply Fast, And Follow Up High-Value Quotes",
