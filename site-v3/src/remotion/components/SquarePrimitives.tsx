...
export const SquareCard = ({ children, style }: { children: ReactNode; style?: React.CSSProperties }) => (
  <div
    style={{
      ...
      borderRadius: 0,
      background: "linear-gradient(180deg, rgba(255,255,255,.055), rgba(255,255,255,.01)), rgba(14,34,51,.96)",
      boxShadow: `10px 10px 0 ${colors.blue}, 0 22px 70px rgba(0,0,0,.34)`,
      ...style,
    }}
  >
    {children}
  ...
  return (
    <div
      style={{
        ...
        boxShadow: "0 0 26px rgba(255,139,61,.75)",
      }}
    />
  );
};
...
export const Dot = ({ active = true, size = 18 }: { active?: boolean; size?: number }) => (
  <div
    style={{
      ...
      boxShadow: active ? "0 0 22px rgba(255,90,31,.72)" : "none",
      border: `3px solid ${active ? "#0E2233" : "rgba(255,255,255,.22)"}`,
    }}
  />
);
