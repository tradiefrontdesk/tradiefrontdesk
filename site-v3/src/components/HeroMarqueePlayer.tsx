...
import { colors } from "@/remotion/components/theme";
...
const MarqueeScene = ({ items }: HeroMarqueePlayerProps) => (
  <div
    style={{
      ...
      overflow: "hidden",
      background:
        `radial-gradient(circle at 14px 14px, rgba(255,90,31,.24) 3px, transparent 3.5px), linear-gradient(rgba(255,255,255,.08) 2px, transparent 2px), linear-gradient(90deg, rgba(255,255,255,.08) 2px, transparent 2px), ${colors.canvas}`,
