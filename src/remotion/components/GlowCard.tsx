...
export const GlowCard = ({ children, style, tone = "dark" }: Props) => (
  <div
    style={{
      position: "relative",
      overflow: "hidden",
      border: tone === "yellow" ? "1px solid transparent" : "1px solid rgba(204,120,92,.32)",
      borderRadius: 22,
      ...
      boxShadow: tone === "yellow" ? "0 0 54px rgba(204,120,92,.26)" : "0 24px 80px rgba(0,0,0,.34), 0 0 36px rgba(204,120,92,.10)",
      ...style,
    }}
  >
    {children}
